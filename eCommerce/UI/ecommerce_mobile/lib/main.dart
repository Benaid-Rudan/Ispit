...
import 'package:ecommerce_mobile/providers/kategorija_transakcije.dart.dart';
...
void main() {
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider<FinansijskiLimitProvider>(
        create: (context) => FinansijskiLimitProvider()), 

...
import 'package:ecommerce_mobile/screens/rezervacija_list.dart';
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            ListTile(title: Text('Rezervacija List'), onTap: () {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => RezervacijaList()));
            },),

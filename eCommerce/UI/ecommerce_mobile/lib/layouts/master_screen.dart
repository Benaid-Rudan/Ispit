...
import 'package:ecommerce_mobile/screens/transakcija_list.dart';
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            ListTile(title: Text('Transakcija'), onTap: () {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => TransakcijaList()));
            },),
          ],
        ),
      ),

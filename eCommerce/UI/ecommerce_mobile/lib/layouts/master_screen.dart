        ...
        child: ListView(
          children: [
            ...
            ListTile(title: Text('Challenge'), onTap: () async {
              ...
              var currentUserId = await userProvider.getCurrent();
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ChallengeListScreen(user: currentUserId)));
            },),
          ],
        ),
      ),

...
{
    /// <inheritdoc />
    public partial class pokusajChallenge : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NazivIzazova = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PraviloUspjeha = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TipIzazova = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipNagrade = table.Column<int>(type: "int", nullable: false),
                    Uslov = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Vrijednost = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChallengeReward", x => x.ChallengeRewardId);
                    table.ForeignKey(
                        name: "FK_ChallengeReward_Challenge_ChallengeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IzazvaniId = table.Column<int>(type: "int", nullable: false),
                    ChallengeId = table.Column<int>(type: "int", nullable: false),
                    StatusIzazova = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengeReward_ChallengeId",

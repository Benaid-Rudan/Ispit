        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pravilo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengeId = table.Column<int>(type: "int", nullable: false),
                    StatusPeera = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserChallenge_Users_KorisnikId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserChallenge_KorisnikId",
                table: "UserChallenge",
                column: "KorisnikId");
        }

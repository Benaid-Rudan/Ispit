...
namespace eCommerce.Services.Migrations
{
    ...
    [Migration("20250825131130_pokusajChallenge")]
    partial class pokusajChallenge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Challenge", b =>
                {
                    ...
                    b.Property<string>("NazivIzazova")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PraviloUspjeha")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TipIzazova")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eCommerce.Services.Database.ChallengeReward", b =>
                {
                    b.Property<int>("ChallengeRewardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChallengeRewardId"));
                    ...
                    b.Property<int>("TipNagrade")
                        .HasColumnType("int");

                    b.Property<string>("Uslov")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("ChallengeRewardId");

                    b.HasIndex("ChallengeId");

                    b.ToTable("ChallengeReward");
                });
            ...
            modelBuilder.Entity("eCommerce.Services.Database.PeerChallenge", b =>
                {
                    b.Property<int>("PeerChallengeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PeerChallengeId"));
                    ...
                    b.Property<int>("IzazivacId")
                        .HasColumnType("int");

                    b.Property<int>("IzazvaniId")
                        .HasColumnType("int");

                    b.Property<int>("Status")
                        .HasColumnType("int");

                    b.HasKey("PeerChallengeId");

                    b.HasIndex("ChallengeId");

                    b.HasIndex("IzazivacId");

                    b.HasIndex("IzazvaniId");

                    b.ToTable("PeerChallenge");
                });
            ...
            modelBuilder.Entity("eCommerce.Services.Database.UserChallenge", b =>
                {
                    ...
                    b.Property<DateTime>("DatumPrihvatanja")
                        .HasColumnType("datetime2");

                    b.Property<int>("IzazvaniId")
                        .HasColumnType("int");

                    b.Property<int>("Napredak")
                        .HasColumnType("int");

                    b.Property<int>("StatusIzazova")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerce.Services.Database.ChallengeReward", b =>
                {
                    b.HasOne("eCommerce.Services.Database.Challenge", "Challenge")
                        .WithMany()
            ...
            modelBuilder.Entity("eCommerce.Services.Database.PeerChallenge", b =>
                {
                    ...
                    b.HasOne("eCommerce.Services.Database.User", "Izazivac")
                        .WithMany("SentChallenges")
                        .HasForeignKey("IzazivacId")
                        .IsRequired();

                    b.HasOne("eCommerce.Services.Database.User", "Izazvani")
                        .WithMany("ReceivedChallenges")
                        .HasForeignKey("IzazvaniId")
                        .IsRequired();

                    b.Navigation("Challenge");

                    b.Navigation("Izazivac");

                    b.Navigation("Izazvani");
                });

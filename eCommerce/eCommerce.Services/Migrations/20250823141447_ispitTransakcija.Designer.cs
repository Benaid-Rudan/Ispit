...
namespace eCommerce.Services.Migrations
{
    ...
    [Migration("20250823141447_ispitTransakcija")]
    partial class ispitTransakcija
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Services.Database.FinansijskiLimit", b =>
                {
                    b.Property<int>("FinansijskiLimitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FinansijskiLimitId"));
                    ...
                    b.ToTable("FinansijskiLimit");
                });

            modelBuilder.Entity("eCommerce.Services.Database.KategorijaTransakcije", b =>
                {
                    b.Property<int>("KategorijaTransakcijeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KategorijaTransakcijeId"));
                    ...
                    b.HasKey("KategorijaTransakcijeId");

                    b.ToTable("KategorijaTransakcije");
                });
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Transakcija", b =>
                {
                    ...
                    b.Property<int>("StatusTransakcije")
                        .HasColumnType("int");

                    b.HasKey("TransakcijaId");

                    b.HasIndex("KategorijaTransakcijeId");
            ...
            modelBuilder.Entity("eCommerce.Services.Database.TransakcijaLog", b =>
                {
                    b.Property<int>("TransakcijaLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TransakcijaLogId"));
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Transakcija", b =>
                {
                    b.HasOne("eCommerce.Services.Database.KategorijaTransakcije", "KategorijaTransakcije")
                        .WithMany()
                        .HasForeignKey("KategorijaTransakcijeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
